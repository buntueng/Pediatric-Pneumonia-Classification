...
# 1. CONFIGURATION
# =============================================================================
DATASET_PATH = "/home/eecommu06/Desktop/Bee/Pediatric_Pneumonia/glcm_dataset"
OUTPUT_PATH = "/home/eecommu06/Desktop/Bee/Pediatric_Pneumonia/output/glcm_efficientnet"

MODEL_NAME = "glcm_efficientnet_b0"
...
OLD_HISTORY_CSV_PATH = os.path.join(OUTPUT_PATH, "training_history_glcm_effnet.csv")
OLD_RESULTS_CSV_PATH = os.path.join(OUTPUT_PATH, "glcm_effnet_results.csv")
...
experiment_config = {
    ...
    "run_id": RUN_ID,
    "glcm_dataset_path": DATASET_PATH,
    ...
    "augmentation": {
        "used": False,
        "details": "Original efficientnetb0_glcm.py used precomputed GLCM image resize + tensor conversion + ImageNet normalization only.",
        "rotation_degrees": 0,
        "translation": 0,
        "brightness_jitter": 0,
        "contrast_jitter": 0,
...
# This GLCM-only baseline uses precomputed GLCM map images. The training script
# does not generate GLCM maps itself, so generation parameters must be copied
# from the separate GLCM data-preparation script when available.
glcm_config = {
    "used_in_this_model": True,
    "model_name": MODEL_NAME,
    "glcm_input_path": DATASET_PATH,
    "note": "This script trains EfficientNet-B0 on precomputed GLCM map images. Generation parameters must match the separate GLCM data-preparation script.",
    "image_size_used_by_training": list(IMG_SIZE),
    "texture_maps_expected_from_manuscript": ["contrast", "dissimilarity", "entropy"],
    "compute_glcm_after_resize": "not_specified_in_original_efficientnetb0_glcm_py",
    "gray_levels": "not_specified_in_original_efficientnetb0_glcm_py",
    "window_size": "not_specified_in_original_efficientnetb0_glcm_py",
    "distances": "not_specified_in_original_efficientnetb0_glcm_py",
    "angles_degrees": "not_specified_in_original_efficientnetb0_glcm_py",
    "offsets": "not_specified_in_original_efficientnetb0_glcm_py",
    "direction_aggregation": "not_specified_in_original_efficientnetb0_glcm_py",
    "border_handling": "not_specified_in_original_efficientnetb0_glcm_py",
    "entropy_formula": "not_specified_in_original_efficientnetb0_glcm_py",
    "map_channel_order": "read_as_RGB_from_precomputed_GLCM_image",
    "normalization": "ImageNet mean/std after reading precomputed GLCM image as RGB",
}
...
model_config = {
    ...
    "fusion": {
        ...
        "raw_branch_weight_placeholder": 0.0,
        "texture_branch_weight_placeholder": 1.0,
        "note": "GLCM-only baseline placeholder. Real adaptive fusion weights must be saved by the fusion/SE model.",
    },
}
...
# =============================================================================
# 13. FUSION WEIGHT AND BRANCH-COMPARISON PLACEHOLDERS FOR GLCM BASELINE
# =============================================================================
...
fusion_df["note"] = "single_glcm_texture_branch_baseline_placeholder_not_real_fusion"
...
branch_df["texture_branch_prob_positive"] = predictions_df["prob_positive"].values
branch_df["fused_prob_positive"] = predictions_df["prob_positive"].values
branch_df["branch_agreement"] = "not_applicable_single_branch"
branch_df["note"] = "GLCM-only baseline; raw/fusion probabilities must come from fusion script"
