...
OUTPUT_PATH = '/home/eecommu06/Desktop/Bee/Pediatric_Pneumonia/output/resnet'

# Original filenames retained
MODEL_SAVE_PATH = os.path.join(OUTPUT_PATH, 'resnet_model_fold{}.pth')
HISTORY_CSV_PATH = os.path.join(OUTPUT_PATH, 'training_history_resnet.csv')
RESULTS_CSV_PATH = os.path.join(OUTPUT_PATH, 'resnet_results.csv')
...
print(f"Running GLCM Branch (ResNet-18) on: {DEVICE}")
...
save_json({
    ...
    'augmentation': {
        'used': False,
        'details': 'Original resnet_glcm.py used resize + tensor conversion + ImageNet normalization only.',
        'rotation_degrees': 0,
        'translation': 0,
        'brightness_jitter': 0,
        'contrast_jitter': 0,
...
save_json({
    ...
    'compute_glcm_after_resize': 'not_specified_in_original_resnet_glcm_py',
    'gray_levels': 'not_specified_in_original_resnet_glcm_py',
    'window_size': 'not_specified_in_original_resnet_glcm_py',
    'distances': 'not_specified_in_original_resnet_glcm_py',
    'angles_degrees': 'not_specified_in_original_resnet_glcm_py',
    'offsets': 'not_specified_in_original_resnet_glcm_py',
    'direction_aggregation': 'not_specified_in_original_resnet_glcm_py',
    'entropy_formula': 'not_specified_in_original_resnet_glcm_py',
    'border_handling': 'not_specified_in_original_resnet_glcm_py',
...
save_json({
    ...
    'texture_branch': {
        ...
        'classifier': 'Dropout(0.2) -> Linear(512,num_classes)',
    },
    'fusion': {
        'used': False,
...
print(f"\nStarting {N_FOLDS}-Fold Cross Validation (GLCM Branch - ResNet18)...")
...
plot_confusion_matrix(cm, dataset.classes, os.path.join(OUTPUT_PATH, 'confusion_matrix.png'), 'Confusion Matrix: GLCM ResNet18')
# Also keep copy in figures
plot_confusion_matrix(cm, dataset.classes, os.path.join(FIGURE_DIR, 'confusion_matrix.png'), 'Confusion Matrix: GLCM ResNet18')
...
print("\nGLCM Branch (ResNet-18) Training Complete.")
